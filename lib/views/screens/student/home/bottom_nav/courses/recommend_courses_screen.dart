...
class RecommendCoursesScreen extends StatelessWidget {
  final StudentController controller;

  const RecommendCoursesScreen({super.key, required this.controller});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('All Recommend Courses 💡'),
      ),
